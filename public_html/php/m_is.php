...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        {
          $mid = $_GET['mid'];
          if(!is_null($_GET['iid'])&&!is_null($_GET['inTree']))
          {
              $inTree = m_i::CheckInTree($mid,$_GET['iid']);
              print(json_encode($inTree));
              exit();
          }
          else
          {
    ...
    else if(!is_null($_POST['remove']))
    {
      m_i::unbindMemberInterest($_POST['mid'],$_POST['iid']);
      exit();
    }
